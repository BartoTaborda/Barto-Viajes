...
/* ----------- OBJETO CON LAS PROP DEL EFECTO LIGHTBOX ----------- */
var propLightbox = {
...
var metLightbox = {
    ...
    inicio: function () {
        for (let index = 0; index < propLightbox.imgContainer.length; index++) {
            propLightbox.imgContainer[index].addEventListener('click', metLightbox.capturaImagen);
        }
    },
